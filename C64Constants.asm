...
.label COLORRAM        = $D800
.label SPRITE0         = $07F8
.label PAL_NTSC        = $02A6          // 0 = NTSC, 1 = PAL
...
.const GM_GameSetUp                = 0
.const GM_TitleScreen              = 1
.const GM_GetCombination           = 2
.const GM_ComputerSays             = 3
.const GM_HumanCopies              = 4
.const GM_LostALife                = 5
.const GM_EndOfGame                = 6
